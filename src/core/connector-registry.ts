...
/** Structured payload for outbound delivery (heartbeat, cron, etc.). */
...
export interface ConnectorCapabilities {
  ...
  push: boolean
  /** Can deliver media attachments (images). */
  media: boolean
}

/**
 * A connector that can deliver outbound messages to a user.
 *
...
export interface Connector {
  ...
  /** Deliver a structured payload through this connector. */
