 ...
 * (next: 0039) — never reuse a retired id, since existing installs' journals
...
import { migration as migration_0038_workspace_runtime_modes } from './0038_workspace_runtime_modes/index.js'
...
export const REGISTRY: Migration[] = [
  ...
  migration_0038_workspace_runtime_modes,
]
