 ...
 *  Pass `provider` to select a quote vendor (e.g. `tencent` for CN L1). */
function quoteEndpoint<T>(
  symbol: string,
...
export const marketApi = {
  ...
  equity: {
    ...
    quote: (symbol: string, opts?: { provider?: string }) => quoteEndpoint<EquityQuote>(symbol, opts),
