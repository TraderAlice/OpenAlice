...
export function DemoBanner(): ReactElement {
  ...
  return (
    <div className="oa-demo-banner flex min-h-9 items-center gap-2 border-b px-2 py-1 text-[12px] text-foreground sm:gap-3 sm:px-3">
      <span className="inline-flex h-6 shrink-0 items-center px-1 text-[11px] font-medium text-warning">
        {t('demoBanner.badge')}
      </span>
      <span
      ...
      <a
        ...
        className="oa-demo-install oa-pressable inline-flex h-7 shrink-0 items-center gap-1.5 rounded-md px-2.5 text-[11px] font-medium text-foreground"
      >
