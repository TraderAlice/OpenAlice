...
export const demoCredentialPresets = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'openai/gpt-5.6-luna', label: 'GPT 5.6 Luna (Cost-efficient)', semantics: { contextWindow: 400_000, maxOutputTokens: 128_000, reasoning: { mode: 'optional', efforts: ['none', 'low', 'medium', 'high', 'xhigh', 'max'], defaultEffort: 'medium' } } },
      ...
      properties: {
        ...
        model: {
          ...
          oneOf: [
            ...
            { const: 'openai/gpt-5.6-luna', title: 'GPT 5.6 Luna (Cost-efficient)' },
