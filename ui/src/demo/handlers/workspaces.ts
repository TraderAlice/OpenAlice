  ...
  http.get('/api/workspaces/:id/launch-plan', ({ params, request }) => {
    ...
    const capabilities = agent === 'shell'
      ...
      : {
          ...
          resumeById: true,
          transcriptDiscovery: agent === 'claude' || agent === 'omp' ? 'fs-watch' as const : agent === 'pi' ? 'none' as const : 'subprocess' as const,
          headless: true,
        }
