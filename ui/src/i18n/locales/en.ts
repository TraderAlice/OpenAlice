...
export const en = {
  ...
  settings: {
    ...
    themeManager: {
      ...
      base16Label: 'Base16 palette', ansiLabel: 'ANSI 0–15', extendedAnsiLabel: 'Extended ANSI 16–21',
      appearance: {
        terminal: 'Terminal theme', followApp: 'Follow application', override: 'Independent terminal theme',
        marketColors: 'Market color source', marketDirection: 'Market direction convention', statusColors: 'Status color source',
        protected: 'Protected colors', theme: 'Theme colors', greenUp: 'Green up / red down', redUp: 'Red up / green down',
        systemUnavailable: 'System mode requires both light and dark variants.',
        deleteReferenced: 'Switch the active or terminal theme before deleting this family.',
      },
      generator: {
        title: 'Generate from an image', description: 'Preview a theme locally before saving it.', refresh: 'Refresh tools',
        matugen: 'Matugen', hellwal: 'Hellwal', unavailable: 'Not found on the application PATH', unsupported: 'Installed but unsupported',
        available: 'Available', executablePath: 'Executable path', version: 'Version', capabilities: 'Verified capabilities',
        image: 'Image', chooseImage: 'Choose image', familyName: 'Theme name', modes: 'Variants', scheme: 'Material scheme',
        darkOffset: 'Dark offset', brightOffset: 'Bright offset', offsetHint: '0–1', generate: 'Generate preview', generating: 'Generating…', cancel: 'Cancel generation',
        cancelled: 'Generation cancelled. Your inputs were preserved.', failed: 'Generation failed', stale: 'Tool changed; refresh its capabilities.',
        save: 'Save generated theme', fullFamily: 'Light and dark family', singleVariant: 'Single variant',
      },
      provenance: {
        title: 'Source details', source: 'Source', mappingVersion: 'Mapping version', contentDigest: 'Content digest',
        imageDigest: 'Image digest', importedAt: 'Imported', generatedAt: 'Generated', parameters: 'Parameters', author: 'Author',
      },
      crossSurfacePreview: {
        title: 'Cross-surface preview', description: 'Candidate colors only; the active appearance is unchanged.',
        application: 'Application and interaction', surface: 'Surface and body text', textHierarchy: 'Text hierarchy', mutedText: 'Muted supporting text',
        hover: 'Hover', active: 'Active', selection: 'Selection', focus: 'Keyboard focus', success: 'Success', warning: 'Warning', danger: 'Danger', info: 'Information',
        market: 'Market and chart', chart: 'Candlestick, volume, and chart chrome preview', pnlUp: 'Positive P&L', pnlDown: 'Negative P&L', buy: 'Buy direction', sell: 'Sell direction',
        risk: 'Invariant risk meanings', destructive: 'Destructive action', permissionDenied: 'Permission denied', tradeConfirm: 'Real trade confirmation', brokerFailure: 'Broker write failed', riskBlocked: 'Risk control blocked',
        terminal: 'Terminal palette', terminalSelection: 'Selected terminal text',
      },
    },
    dataHome: {
      title: 'Data location',
