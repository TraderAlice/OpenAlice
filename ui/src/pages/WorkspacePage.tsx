  ...
  if (!workspace) {
    return (
      <div className="workspaces-root flex flex-col items-center justify-center h-full text-text-muted text-sm">
        {t('workspaces.workspaceNotFound', 'Workspace not found. It may have been deleted.')}
      </div>
    )
  }
      ...
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-border bg-bg-secondary/30 shrink-0">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            title={t('workspaces.configureAIProvider', "Configure this workspace's AI provider (claude / codex)")}
          >
            ...
            {t('workspaces.aiProvider', 'AI Provider')}
          </button>
        </div>
      </div>
