...
export type ViewSpec =
  ...
  | { kind: 'settings';       params: { category: 'general' | 'appearance' | 'pet' | 'activity-bar' | 'visibility' | 'ai-provider' | 'workspace-injection' | 'agent-runtimes' | 'agent-permissions' | 'tools' | 'trading' | 'issues' | 'connectors' | 'mcp' | 'market-data' | 'news-collector' | 'beta' } }
